                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Summers By Diamond USA</li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">info@SummersByDiamond.com </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="tel:+452373 95593 232">+452373 95593 232</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>Powered By <a href="#">Summers By Diamond</a>. Store 1 © 2019</p>
                        </div>
                    </div>
                </div>
            </div>
