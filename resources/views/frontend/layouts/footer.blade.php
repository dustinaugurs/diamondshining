    ...
    <!-- footer area start -->
    <footer class="footer-widget-area footerbox" id="contact-sec">
                ...
                <div class="row">
                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    ...
                                    <a href="tel:0207869525">0207 869525</a></li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="newsletter-wrapper">
                            <h6 class="widget-title" style="margin-bottom:10px">Signup for newsletter</h6>
                            <form class="newsletter-inner" action="{{url('SubscriberMail')}}" method="post">
                                @csrf
                                <input type="email" class="news-field" name="mcemail" id="mcemail" autocomplete="off" placeholder="Enter your email address" required>
                                <button type="submit" class="news-btn"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
