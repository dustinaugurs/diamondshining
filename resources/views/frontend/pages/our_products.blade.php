								...
								<div class="col-md-12">
										<nav>
											<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
												<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#certified-colourless-diamonds" role="tab" aria-controls="nav-home" aria-selected="true">{{ trans('frontend.product.tab.certified') }}</a>
...
function numeric_only (event, input) {
	...
	//==================
// function myFunction() {
// 	var x = document.getElementById("Search-for-Diamonds-wrp1");
...
//alert(hggjkjk)
    ...
    //     if(href=="certified-colourless-diamonds"){
	// 	   message = 'Certified Colourless Diamonds';
    //     }else if(href=="fancy-coloured-diamonds"){
	// 		message = 'Fancy Coloured Diamonds';
    //     }else if(href=="canada-mark-diamonds"){
	// 		message = 'Canada Mark Diamonds';
    //     }else if(href=="lab-Grown-Diamonds"){
	// 		message = 'Lab Grown Diamonds';
    //     }else if(href=="melee-diamonds"){
	// 		message = 'Melee Diamonds';
    //     }
	// 	if(confirm("Do you want to go on "+message+" Tab")){
	// 	  toastr.success('You are on '+message+' Section');
    //      }
    //     else{
	// 	$(this).css({"background-color": "#002853 !important",})	
    //     return false;
    //      }
    // });
    //------------------------------
