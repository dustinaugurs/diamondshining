...
<div class="tab">   
  ...
  <button class="tablinks active"><a href="{{url('enquiry-order/ordersCompleted')}}">Orders Completed</a></button>
...
<th>Date 
        <div class="changedatabox">
            <select name="changedatetime" id="changedatetime">
