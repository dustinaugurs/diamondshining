...
<input type="number" step="any" min=0 max="9900" oninput="validity.valid||(value='0');" id="min_price1" class="price-range-field Min-Price-in" />
      <input type="number" step="any" min=0 max="10000" oninput="validity.valid||(value='10000');" id="max_price1" class="price-range-field Max-Price-in" />
...
<button type="button" class="btn gp-btn">EGL</button>
...
<tr>
    ...
    <th>Detail / Order</th>
            ...
            <tbody>
<tr colspan="16" data-toggle="collapse" data-target="#demo1" class="accordion-toggle">               
    <td>360</td>
    <td><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img img33"></td>
    <td>Delivery Daye(i)</td>
    <td>Shape</td>
    <td>Cert</td>
    <td>Carat</td>
    <td>Colour</td>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">Image</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content">
  <div class="tab-pane active container" id="home">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
...
<td>5.73x5.70x3.52</td>
    ...
    <div class="col">        
<div class="price-wrp">758.65</div>
<div class="price-sub">(EX. VAT)</div>
<div class="order-btn-wrp"><a href="#" class="order-btn"> ORDER</a></div>
<div class="enquire-btn-wrp"><a href="#" class="enquire-btn"> ENQUIRE </a></div>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#Image2">Image</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#Video2">Video</a>
  </li>
...
<!-- Tab panes -->
<div class="tab-content">
  <div class="tab-pane active container" id="Image2">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
  <div class="tab-pane container" id="Video2">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
</div>
</div>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#Image3">Image</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#Video3">Video</a>
  </li>
...
<!-- Tab panes -->
<div class="tab-content">
  <div class="tab-pane active container" id="Image3">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
  <div class="tab-pane container" id="Video3">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
</div>
</div>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#Image4">Image</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#Video4">Video</a>
  </li>
...
<!-- Tab panes -->
<div class="tab-content">
  <div class="tab-pane active container" id="Image4">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
  <div class="tab-pane container" id="Video4">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
</div>
</div>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#Image5">Image</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#Video5">Video</a>
  </li>
...
<!-- Tab panes -->
<div class="tab-content">
  <div class="tab-pane active container" id="Image5">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
  <div class="tab-pane container" id="Video5">
    <p><img src="http://dimonds.augurstechnologies.com/public/assets/img/product/No_image.jpg" alt="product" class="sec-img"></p>
</div>
</div>
</div>
...
<div class="enquire-btn-wrp"><a href="#" class="enquire-btn"> ENQUIRE </a></div>
                    ...
                    <div class="col-lg-12 order-1">
                        <div class="shop-product-wrapper" style="display: none;">
