       ...
       $(document).on('click','.shortby_clarity_asc',function(e){
           var short_data  = $(this);
            ...
            //alert(short_data_val);
             shape_arr =  return_shape_filter();
             get_product(shape_arr,max_price , min_price , max_price1 
             , min_price1,min_depth , max_depth ,min_table , max_table ,min_ratio ,max_ratio, cut_div_val , color_div_val , cla_div_val, certi_div_val ,pol_div_val ,sym_div_val, flo_div_val, short_data_clarity_asc);
