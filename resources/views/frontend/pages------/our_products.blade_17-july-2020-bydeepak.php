...
<div class="text-center col-md-12 m-t-60"><a class="btn-primary btn-new2" onclick="myFunction()">Search</a></div>                      




<div class="Search-for-Diamonds-wrp"  id="Search-for-Diamonds-wrp" style="display: none;">
    <div class="Search-for-Diamonds">
    <div class="row">      
<div class="col-md-12 text-center" style="margin: 15px;"><i class="fa fa-undo" aria-hidden="true"></i> 
<button type="button" class="button1">Reset Filters</button>
</div>
</div>
</div>
...
<h4>Certified Colourless diamonds</h4>
