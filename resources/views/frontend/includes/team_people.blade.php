                            ...
                            <div class="row">
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{url('public/img/frontend/img/team/people/people-1.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{url('public/img/frontend/img/team/people/people-2.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{url('public/img/frontend/img/team/people/people-3.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="team_img_item">
                                        <img src="{{url('public/img/frontend/img/team/people/people-4.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
