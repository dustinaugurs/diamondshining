...
@section('content')
    <div class="box box-info">
        ...
        <div class="tab">   
  <button class="tablinks"><a href="{{url('admin/requestForImage')}}">{{ trans('labels.backend.orders.imagerequest') }}</a></button>
  <button class="tablinks active"><a href="{{url('admin/requestForVideo')}}">{{ trans('labels.backend.orders.videorequest') }}</a></button>
...
@section('after-scripts')
  ...
  $(function () {
    ...
    var table = $('#data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('admin/requestForVideo') }}",
        type: 'get',
        columns: [
            //{data: 'id', name: 'id'},
