...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.diamondtemplates.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.diamondtemplates.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-diamondtemplate']) }}

        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.diamondtemplates.create') }}</h3>
