<!--Action Button-->
@if( Active::checkUriPattern( 'admin/diamondtemplates' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.diamondtemplates.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.diamondtemplates.all' ) }}
            </a>
        </li>
        @permission( 'create-diamondtemplate' )
            <li>
                <a href="{{ route( 'admin.diamondtemplates.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.diamondtemplates.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
