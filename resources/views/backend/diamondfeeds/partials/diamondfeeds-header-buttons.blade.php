<!--Action Button-->
@if( Active::checkUriPattern( 'admin/diamondfeeds' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.diamondfeeds.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.diamondfeeds.all' ) }}
            </a>
        </li>
        @permission( 'create-diamondfeed' )
            <li>
                <a href="{{ route( 'admin.diamondfeeds.create' ) }}">
