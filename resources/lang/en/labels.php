...
return [
	...
	"carats" => "Carats Weight",
	"weight" => "Weight",
	"colclar" => "Colclar",
	"measurements" => "Measurements(W/H/L/D)",
	"cut" => "Cut",
	"pol" => "Pol",
	"symm" => "Symm",
	"flo" => "Flo",
	...
	"image" => "Image",
	"pdf" => "PDF",
	"mine_of_origin" => "Mine of Origin",
	"canada_mark_eligble" => "Canada Mark Elig",
	],
	"diamondtemplates" => [
	"create" => "Create Diamond Markup",
	"edit" => "Edit Diamond Markup",
	"management" => "Diamond Markup Management",
	"title" => "Diamond Markup",
	"table" => [
	"id" => "Id",
	"createdat" => "Created At",
	],
