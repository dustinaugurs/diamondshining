...
return [
	...
	"diamondfeeds" => [
	"already_exists" => "That DiamondFeed already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this DiamondFeed. Please try again.",
	"delete_error" => "There was a problem deleting this DiamondFeed. Please try again.",
	"not_found" => "That DiamondFeed does not exist.",
	"update_error" => "There was a problem updating this DiamondFeed. Please try again.",
	],
	"diamondtemplates" => [
	"already_exists" => "That DiamondTemplate already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this DiamondTemplate. Please try again.",
	"delete_error" => "There was a problem deleting this DiamondTemplate. Please try again.",
	"not_found" => "That DiamondTemplate does not exist.",
	"update_error" => "There was a problem updating this DiamondTemplate. Please try again.",
	],
	"diamonds" => [
	"already_exists" => "That Diamond already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Diamond. Please try again.",
	"delete_error" => "There was a problem deleting this Diamond. Please try again.",
	"not_found" => "That Diamond does not exist.",
	"update_error" => "There was a problem updating this Diamond. Please try again.",
	],
	"orders" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://diamondlaravel.test/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
