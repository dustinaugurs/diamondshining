...
class ModulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $modules = [
            ...
            [
                'name'                  => trans('menus.backend.diamondfeeds.management'),
                'url'                   => 'admin.diamondfeeds.index',
                'view_permission_id'    => 'view-diamondfeeds-permission',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
            [
                'name'                  => trans('menus.backend.diamondtemplates.management'),
                'url'                   => 'admin.diamondtemplates.index',
                'view_permission_id'    => 'view-diamondtemplates-permission',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
        ];
